...
declare global {
  ...
  const calculateMaxScaleConstraints: typeof import('./src/modules/PulsesViewer/store/view.store')['calculateMaxScaleConstraints']
  ...
  const darkColors: typeof import('./src/stores/colors')['darkColors']
  ...
  const slicers: typeof import('./src/modules/PulsesViewer/models/MeasurementDecoders')['slicers']
  ...
  const useConfig: typeof import('./src/modules/PulsesViewer/store/config')['useConfig']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useConfig: UnwrapRef<typeof import('./src/modules/PulsesViewer/store/config')['useConfig']>
